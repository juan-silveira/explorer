...
const get_summary = async (coin, exchange, cb) =>{
  ...
  request({uri: req_url, json: true}, function (error, response, body) {
    if (error) {
      ...
      if (body.message) {
        ...
        return cb (null, parseFloat(quotes.last));
      }
    }
  });
}

const get_trades = async (coin, exchange, cb) =>{
...
const get_orders = async (coin, exchange, cb) =>{
